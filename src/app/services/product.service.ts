...
export class ProductService {
  ...
  getCardData(): Observable<any> {
    return this.http.get('https://job-portal-a9eaf-default-rtdb.firebaseio.com/products.json').pipe(
      map(responseObj => {
        const resultArr = [];
  ...
  addNewProduct(form: NewProduct): Observable<any> {
    ...
    return this.http.post('https://job-portal-a9eaf-default-rtdb.firebaseio.com/products.json', submittedProduct)
  }
  ...
  getAProductById(id: string): Observable<any> {
    return this.http.get(`https://job-portal-a9eaf-default-rtdb.firebaseio.com/products/${id
      }.json`)
  }
